...
if (isset($_POST['submit'])) {
    ...
    $p_description = $_POST['key_cities'];
    $img_pays = $_POST['country_img'];
    $id_continent_fk = $_POST['id_continent_fk'];
...
// Récupération des données du pays à éditer
$id = $_GET['id'] ?? null;
if ($id) {
    $paysData = Pays::getById($id);
}
?>
<!DOCTYPE html>
<html lang="fr">
...
<head>
    ...
    <title>AFRINOVA - Edit Country</title>
    ...
    <section class="landingPage h-auto pt-6 flex flex-col items-center">
        ...
        <section class="pb-20 ">
            <form class="flex flex-col gap-4  mx-auto w-full md:w-[800px] bg-gray-50 p-8  rounded shadow" method="POST">
                <input type="hidden" name="id_pays" value="<?php echo $paysData['id_pays']; ?>">
                <input type="hidden" name="id_continent_fk" value="<?php echo $paysData['id_continent_fk']; ?>">
                ...
                <textarea type="text" name="key_cities" id="key-cities" class="p-2 border border-green-900 rounded"
                    placeholder="Enter key cities"><?php echo $paysData['p_description']; ?></textarea>
                ...
                <input type="text" name="country_languages" id="country-languages"
                    class="p-2 border border-green-900 rounded" value="<?php echo $paysData['langues_officielles']; ?>">
                ...
                <input type="text" name="country_img" id="country-img" class="p-2 border border-green-900 rounded"
                    value="<?php echo $paysData['img_pays']; ?>">
