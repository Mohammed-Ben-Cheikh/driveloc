                ...
                <?php foreach ($themes as $theme): ?>
                    <div
                        ...
                        <div class="relative h-64">
                            ...
                            <img src="../../Dashboard/<?php echo htmlspecialchars($theme['image_url'] ?: 'img/default-category.jpg'); ?>"
                                class="absolute w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700"
                                alt="<?php echo htmlspecialchars($theme['nom']); ?>">
                        </div>
                        <div class="relative z-50 p-6 -mt-20">
                            ...
                            <p class="text-gray-400 mb-6 line-clamp-2"><?php echo htmlspecialchars($theme['description']); ?>
                            </p>
                            <div class="flex justify-between items-center">
                                ...
                                <a href="<?= isset($theme['id_theme']) ? 'articles.php?theme=' . htmlspecialchars($theme['id_theme']) : '#' ?>"
            ...
            <ul class="flex justify-center space-x-2">
                <li>
                    <?php if ($page > 1): ?>
                        <a href="?page=<?php echo $page - 1; ?>"
                            class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">&laquo;
                            Précédent</a>
                    <?php else: ?>
                        <span class="px-4 py-2 bg-gray-300 text-gray-600 rounded-lg cursor-not-allowed">&laquo;
                            Précédent</span>
                    <?php endif; ?>
                </li>
                <?php
                ...
                <li>
                    <?php if ($page < $totalPages): ?>
                        <a href="?page=<?php echo $page + 1; ?>"
                            class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">Suivant
                            &raquo;</a>
                    <?php else: ?>
                        <span class="px-4 py-2 bg-gray-300 text-gray-600 rounded-lg cursor-not-allowed">Suivant
                            &raquo;</span>
                    <?php endif; ?>
                </li>
            </ul>
        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul class="text-white dark:text-gray-400 font-medium">
                            <li class="mb-4"><a href="https://github.com/themesberg/flowbite"
                                    class="hover:underline">Github</a></li>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-bla sm:text-center">© 2023 <a href="https://flowbite.com/"
                        class="hover:underline">DriveLoc™</a>. All Rights Reserved.</span>
